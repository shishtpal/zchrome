...
/// Click an element.
/// use_js=false (default): real CDP Input events (isTrusted: true) — works with
///   Vue/React/Angular and native browser controls like listbox/select.
/// use_js=true: synthetic JS dispatchEvent — use for sites that need JS-driven
///   anchor navigation (e.g. Google search links).
pub fn clickElement(
    session: *cdp.Session,
    allocator: std.mem.Allocator,
    resolved: *const ResolvedElement,
