...
fn buildCtx(args: Args, allocator: std.mem.Allocator) impl.CommandCtx {
    return .{
        ...
        .wait_media_playing = args.wait_media_playing,
        .wait_media_ended = args.wait_media_ended,
        .wait_media_ready = args.wait_media_ready,
        .wait_media_error = args.wait_media_error,
