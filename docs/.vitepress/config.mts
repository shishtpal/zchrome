            ...
            "/api/": [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        { text: "CSS", link: "/api/domains/css" },
                        { text: "Security", link: "/api/domains/security" },
                        { text: "Debugger", link: "/api/domains/debugger" },
                        {
                            text: "Performance",
                            link: "/api/domains/performance",
                        },
            ...
            "/examples/": [
                {
                    ...
                    items: [
                        ...
                        {
                            text: "JavaScript Evaluation",
                            link: "/examples/javascript",
                        },
                        {
                            text: "Network Interception",
                            link: "/examples/network",
                        },
                        {
                            text: "Browser Interactions",
            ...
            "/cli": [
                {
                    ...
                    items: [
                        ...
                        { text: "Cloud Providers", link: "/cli/providers" },
                        ...
                        { text: "CSS Commands", link: "/cli/css" },
                        { text: "Security Commands", link: "/cli/security" },
                        { text: "Debug Commands", link: "/cli/debug" },
